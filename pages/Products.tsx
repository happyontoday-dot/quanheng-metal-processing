  ...
  return (
    <div className="w-full fade-in bg-slate-50 min-h-screen pb-20">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <Link key={service.id} to={`/services/${service.id}`} className="relative h-80 rounded-2xl overflow-hidden hover:scale-[1.02] transition-all duration-300 group cursor-pointer">
              <img
                src={service.image}
                alt={service.title}
                loading="lazy"
